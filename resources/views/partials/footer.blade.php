        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                        <div class="text-xl font-bold text-white">AMC-SRLS</div>
                        <div class="text-sm text-gray-400">Auto Showroom</div>
                    </div>
                </div>
                <p class="text-gray-400 text-sm mb-4 max-w-md">
                    Il tuo partner di fiducia per l'acquisto di auto nuove e usate. 
                    Qualità, trasparenza e professionalità dal 2020.
                </p>
                <div class="flex space-x-4">
                    <a href="#" class="w-9 h-9 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors duration-200">
            ...
            <div>
                <h3 class="text-white font-semibold mb-4">Link Veloci</h3>
                <ul class="space-y-2">
                    <li><a href="/" class="text-sm hover:text-blue-400 transition-colors duration-200">Home</a></li>
                    <li><a href="/inventory" class="text-sm hover:text-blue-400 transition-colors duration-200">Inventario</a></li>
                    <li><a href="/contact" class="text-sm hover:text-blue-400 transition-colors duration-200">Contatti</a></li>
                </ul>
            </div>
