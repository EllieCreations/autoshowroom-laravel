...
@section('keywords', ($car->brand->name ?? '') . ' ' . $car->model . ', auto ' . $car->car_condition . ', ' . ($car->fuelType->name ?? '') . ', auto')

@section('canonical', url('/cars/' . $car->id))

{{-- Open Graph per Social Media --}}
@section('og_type', 'product')
@section('og_title', ($car->brand->name ?? 'Auto') . ' ' . $car->model . ' ' . $car->year)
