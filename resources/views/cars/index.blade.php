...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="mb-4 flex items-center text-sm text-gray-600">
            <a href="{{ route('admin.dashboard') }}" class="hover:text-blue-600 transition-colors flex items-center">
            ...
            <span class="text-gray-900 font-medium">Gestione Auto</span>
        </nav>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <div class="bg-white rounded-xl shadow p-4 border-l-4 border-green-500">
                <div class="text-sm text-gray-600">Nuove</div>
                <div class="text-2xl font-bold text-gray-900">{{ $cars->where('car_condition', 'nuovo')->count() }}</div>
            </div>
            <div class="bg-white rounded-xl shadow p-4 border-l-4 border-yellow-500">
                <div class="text-sm text-gray-600">Usate</div>
                <div class="text-2xl font-bold text-gray-900">{{ $cars->where('car_condition', 'usato')->count() }}</div>
            </div>
            <div class="bg-white rounded-xl shadow p-4 border-l-4 border-purple-500">
                <div class="text-sm text-gray-600">In Evidenza</div>
                <div class="text-2xl font-bold text-gray-900">{{ $cars->where('highlighted', 1)->count() }}</div>
            </div>
        </div>
